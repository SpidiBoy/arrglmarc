 ...
 * Implementa CommandLineRunner para ejecutarse al inicio.
 */
@Component
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        // ── Servicios ──────────────────────────────────────────────────────
        Servicio bano = servicioRepo
                .save(new Servicio("Baño completo", "Baño, secado y perfumado", 45, new BigDecimal("45.00")));
        Servicio corte = servicioRepo
                .save(new Servicio("Corte de pelo", "Corte estilo y acabado", 60, new BigDecimal("60.00")));
        Servicio unias = servicioRepo
                .save(new Servicio("Corte de uñas", "Limado y recorte", 20, new BigDecimal("20.00")));
        Servicio spa = servicioRepo
                .save(new Servicio("Spa completo", "Baño + Corte + Uñas + Masaje", 90, new BigDecimal("110.00")));
        Servicio dental = servicioRepo
                .save(new Servicio("Limpieza dental", "Higiene bucal profesional", 30, new BigDecimal("35.00")));
        ...
        // ── Citas ──────────────────────────────────────────────────────────
        Cita c1 = new Cita(mochi, bano, LocalDate.now(), LocalTime.of(10, 0), "Sofía R.");
        Cita c2 = new Cita(luna, unias, LocalDate.now(), LocalTime.of(11, 30), "Javier M.");
        c2.setEstado("EN_CURSO");
        Cita c3 = new Cita(rocky, spa, LocalDate.now(), LocalTime.of(14, 0), "Sofía R.");
        Cita c4 = new Cita(coco, bano, LocalDate.now().minusDays(1), LocalTime.of(9, 0), "Javier M.");
